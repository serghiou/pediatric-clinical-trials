---
title: 'Pediatric clinical trials: Extract registration date'
...
```{r}
clinicaltrials <- map_dfr(nct_ids, clinicaltrialr::ct_read_trial)
```
...
```{r}
clinicaltrials %>% 
  select(nct_id, ends_with("_date")) %>% 
  write_csv("../../data/raw_data/clinicaltrials_registration-date.csv")
```
